...
<body>
	...
	<form:form action="DeleteF" method="post" style="text-align:center;">
		...
		<hr>
		<hr>
		<input type="text" name="folder" placeholder="Enter the folder to be deleted">
		<input type="submit" value="Delete the folder">
