...
<body>
	...
	<form:form action="Folder" method="post" style="text-align:center;">
		...
		<h1 align="center" style="font-size: xx-large; margin-top: 50px;">Add
			a folder name:</h1>
		<hr>
		<hr>

		<input type="text" placeholder="Add a folder" name="folder">
