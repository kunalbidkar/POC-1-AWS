...
<body>
	...
	<h1 align="center" style="font-size: xx-large; margin-top: 50px;">Current
		Buckets</h1>
		<p>Select the bucket in which you want to insert your file : </p>
	<hr>
	<hr>

	<div style="text-align: center;"></div>
	<form:form action="AddObject" method="post" style="text-align:center;">
		...
		<hr>
		<hr>
		<input type="file" name="addObject">
